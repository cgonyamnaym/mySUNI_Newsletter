...
export function getScoreLabel(
  ...
  if (pct >= 80) return { label: '연관성 매우 높음', bg: 'rgba(0,168,50,0.12)',   text: '#00A832' }
  if (pct >= 60) return { label: '연관성 높음',     bg: 'rgba(72,187,120,0.15)', text: '#276749' }
  if (pct >= 40) return { label: '연관성 보통',     bg: 'rgba(217,119,6,0.12)',  text: '#D97706' }
  if (pct >= 20) return { label: '연관성 낮음',     bg: 'rgba(229,62,62,0.10)',  text: '#E53E3E' }
  return              { label: '연관성 매우 낮음', bg: 'rgba(112,115,124,0.10)', text: '#70737C' }
}
