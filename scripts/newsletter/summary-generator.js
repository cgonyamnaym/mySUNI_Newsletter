...
JSON만 응답 (마크다운 없이):
{
  "what": "행위자 + 기사 유형 + 핵심 수치 포함 (1문장, 60자 이내)",
  "why": "핵심 인과 근거로만 작성 (1문장, 50자 이내) — 핵심 인과가 없음이면 반드시 null",
  "sowhat": "사업 임팩트 근거로만 작성 (1문장, 50자 이내) — 사업 임팩트가 없음이면 반드시 null"
}`
...
- 문장을 자연스럽게 다듬는 것은 허용되지만 의미와 수치를 변경할 수 없습니다.${translateNote}
...
JSON만 응답 (마크다운 없이):
{
  "what": "What 근거 문장을 한국어로 자연스럽게 정제 (1문장, 60자 이내)",
  "why": "Why 근거 문장을 한국어로 자연스럽게 정제 (1문장, 50자 이내) — 근거가 없음이면 반드시 null",
  "sowhat": "So what 근거 문장을 한국어로 자연스럽게 정제 (1문장, 50자 이내) — 근거가 없음이면 반드시 null"
}`
